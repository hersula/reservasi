    ...
    if($row = mysqli_fetch_array($result)){
      ...
      $gen5           = $row["gen5"];
        ...
        echo '<script>
                ...
                swal({
                title: "Maaf!",
                text: "Data Hasil Tes tidak berhasil dilihat.",
                type: "error"
                }, function() {
     ...
     $sql_query1 = "insert into log_file (karyawanID, waktu, infoActivity) 
                    values ('$_SESSION[idKaryawan]',NOW(),'Lihat data master hasil tes') ";
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Lihat Data Hasil Tes</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-md">
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">Form Lihat Data Hasil Tes</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="" method="POST" enctype="multipart/form-data">
              <div class="card-body">
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="text-sm">Nama Pasien 
                        <!--
                        <span class="text-warning">*</span>
                        -->
                      </label>
                      <select disabled  type="text" class="custom-select custom-select-sm" id="idPasien" name="idPasien" required>
                        <option value=""></option>
                        <?php
                    ...
                    <div class="form-group">
                      <label class="text-sm">Pemeriksaan
                       ...
                       -->
                         ...
                         <input readonly required type="text" class="form-control form-control-sm" name="pemeriksaan" placeholder="Pemeriksaan" id="pemeriksaan" value="<?php echo $pemeriksaan; ?>" autocomplete="off" >
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      -->
                         ...
                         <input readonly required type="text" class="form-control form-control-sm" name="spesimen" placeholder="Spesimen" id="spesimen" value="<?php echo $spesimen; ?>" autocomplete="off" >
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      -->
                         ...
                         <input readonly required type="text" class="form-control form-control-sm" name="hasil" placeholder="Hasil Tes" id="hasil" value="<?php echo $hasil; ?>" autocomplete="off" >
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      -->
                         ...
                         <input readonly required type="text" class="form-control form-control-sm" name="keterangan" placeholder="Keterangan" id="keterangan" value="<?php echo $keterangan; ?>" autocomplete="off" >
                    </div>
                  </div>
                </div>
                 <!--end of row Pemeriksaan dan Spesimen-->
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      -->
                         ...
                         <input readonly type="text" class="form-control form-control-sm" name="gen0" placeholder="Gen 0" id="gen0" value="<?php echo $gen0; ?>" autocomplete="off" >
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      -->
                         ...
                         <input readonly type="text" class="form-control form-control-sm" name="gen1" id="gen1"  placeholder="Gen 1" value="<?php echo $gen1; ?>" autocomplete="off" >
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      -->
                         ...
                         <input readonly type="text" class="form-control form-control-sm" name="gen2" id="gen2"  placeholder="Gen 2" value="<?php echo $gen2; ?>" autocomplete="off" >
                    </div>
                  </div>
                </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      -->
                         ...
                         <input readonly type="text" class="form-control form-control-sm" name="gen3" id="gen3"  placeholder="Gen 3" value="<?php echo $gen3; ?>" autocomplete="off" >
                    </div>
                  </div>
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      -->
                         ...
                         <input readonly type="text" class="form-control form-control-sm" name="gen4" id="gen4"  placeholder="Gen 4" value="<?php echo $gen4; ?>" autocomplete="off" >
                    </div>
                  </div>
                </div>
                 <!--end of row Gen1 dan Gen2-->
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      -->
                         ...
                         <input readonly type="text" class="form-control form-control-sm" name="gen5" id="gen5"  placeholder="Gen 5" value="<?php echo $gen5; ?>" autocomplete="off" >
                    </div>
                  </div>
