      ...
      if ($avatar == "" ){
        ...
        while ($rowResult=mysqli_fetch_array($hasil,MYSQLI_ASSOC)){
          ...
          $sql1 = "update master_pasien set nik='$nik', name='$name', phone='$phone', 
                  ...
                  dateOfBirth='$dateOfBirth', passport='$passport', email='$email', 
                ...
                <div class="row">
                  <div class="col-md-6">
                    ...
                    <div class="form-group ">
                      ...
                      <input type="text" class="form-control form-control-sm" name="nik" placeholder="Identity Number (KTP/Passport)" id="nik" onkeyup="isi_otomatis()" value="<?php echo $nik; ?>" />
                    </div>
                  </div>
                  <div class="col-md-6">
                    <div class="form-group">
                ...
                <div class="row">
                  ...
                  <div class="col-md-6">
                    <div class="form-group">
                      ...
                      <input type="date" class="form-control form-control-sm" name="dateOfBirth" id="dateOfBirth" required placeholder="Date of Birth" value="<?php echo $dateOfBirth; ?>" />
                    </div>
                  </div>
                </div>
                <div class="row">
