...
if(isset($_POST["simpan"])){
  ...
  if($error == 0){
      $query = "insert into master_client (typeClientID, nameClient, address, phone, status)
                values ('$typeClientID', '$nameClient', '$address', '$phone', 'Aktif')";
      mysqli_query($conn, $query);
      
      $sql_query1 = "insert into log_file (karyawanID, waktu, infoActivity) 
                    values ('$_SESSION[idKaryawan]',NOW(),'Tambah data klien') ";
      ...
      if(mysqli_error($conn) == "") {
        echo '<script>
                swal({
                title: "Sukses!",
                text: "Data Klien baru berhasil ditambahkan ke dalam sistem.",
                type: "success"
                }).then(function() {
          ...
          echo '<script>
                swal({
                title: "Maaf!",
                text: "Data Klien baru tidak berhasil ditambahkan ke dalam sistem.",
                type: "error"
                }).then(function() {
                window.location = "admin.php?page=klien-data";
                });
        ...
        <div class="col-md">
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">Form Tambah Data Klien</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
            <form action="" method="POST">
              <div class="card-body">
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group">
                      <label class="text-sm">Tipe Klien<span class="text-warning">*</span></label>
