...
if(isset($_POST["simpan"])){
  ...
  if($error == 0){
      $sql_query = "insert into master_target_gen (nameTargetGen, status)
               values ('$nameTargetGen', 'Aktif')";
      mysqli_query($conn, $sql_query);
      
      $sql_query1 = "insert into log_file (karyawanID, waktu, infoActivity) 
                    values ('$_SESSION[idKaryawan]',NOW(),'Tambah data target gen') ";
      ...
      if(mysqli_error($conn) == "") { 
        echo '<script>
                swal({
                title: "Sukses!",
                text: "Data Target Gen baru berhasil ditambahkan ke dalam sistem.",
                type: "success"
                }).then(function() {
        ...
        echo '<script>
                swal({
                title: "Maaf!",
                text: "Data Target Gen baru tidak berhasil ditambahkan ke dalam sistem.",
                type: "error"
                }).then(function() {
                window.location = "admin.php?page=target-gen-data";
                });
...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Tambah Data Target Gen</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-md">
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">Form Tambah Data Target Gen</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
