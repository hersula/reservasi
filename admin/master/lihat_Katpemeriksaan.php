...
if(isset($_GET["id"])){
  $id_kat = $_GET["id"];
    ...
    if($row = mysqli_fetch_array($result)){
      ...
      $isActive    = $row['status'];
        ...
        echo '<script>
              swal({
              title: "Maaf!",
              text: "Data Kategori tidak berhasil dilihat.",
              type: "error"
              }).then(function() {
    ...
    $sql_query1 = "insert into log_file (karyawanID, waktu, infoActivity) 
                    values ('$_SESSION[idKaryawan]',NOW(),'Lihat data Kategori Pemeriksaan') ";
        ...
        <div class="col-md">
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">Form Ubah Data Kategori</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
                ...
                <div class="row">
                  <div class="col-md-6">
                    <div class="form-group ">
                      ...
                      -->
                      <input readonly required type="text" class="form-control" name="nameKat" placeholder="Nama Kategori" id="nameKat" value="<?php echo $nameKat; ?>" autocomplete="off" />
                    </div>
                  </div>
                  <!--end of col-md-6-->
                </div>
