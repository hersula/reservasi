...
<div class="content-wrapper">
  ...
  <div class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1 class="m-0">Lihat Data Pasien</h1>
        </div><!-- /.col -->
        <div class="col-sm-6">
        ...
        <div class="col-md">
          <div class="card card-default">
            <div class="card-header">
              <h3 class="card-title">Form Lihat Data Pasien</h3>
            </div>
            <!-- /.card-header -->
            <!-- form start -->
                    ...
                    <div  class="form-group" >
                      ...
                      <div class="col-sm-6">
                        <div class="form-check-inline">
                          ...
                          <input disabled type="radio" class="form-check-input" id="rbPria" name="gender" <?php if($gender == "Laki-laki") { echo "checked"; } ?> value="Laki-laki">Laki-laki
                          </label>
                        </div>
                        <div class="form-check-inline">
                          <label class="form-check-label" for="rbTidak">
                          <input disabled type="radio" class="form-check-input" id="rbWanita" 
                          name="gender"
