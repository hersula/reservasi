            ...
            <form action="<?= BASE_URL. 'admin/reservasi/back_proses_pendaftaran.php' ?>" method="POST" onsubmit="var r = confirm('Apakah data pasien dan tindakan sudah benar ?'); if (r == true){return true;} else {event.preventDefault; return false;}">
              <div class="card-body">
                ...
                <div class="col-md-4">
                  ...
                  <div class="col-md-4">
                    <div class="form-group">
                      <label class="text-sm">Jenis Tindakan <span class="text-warning">*</span></label>
                      <select multiple="multiple" class="custom-select custom-select-sm" id="targetGenID" name="targetGenID[]" onchange="getPrice()">
                        ...
                        <?php
                          $query= "SELECT master_tindakan.id, master_tindakan.name FROM outlet_tindakan_list 
                                  JOIN master_tindakan ON outlet_tindakan_list.outletTindakan=master_tindakan.id where outlet_tindakan_list.outletID = '$outletID'";
