    ...
    <div class="container-fluid">
        <div class="content-wrapper">
            ...
            <div class="card card-default">
                ...
                <!-- /.card-header -->
                <div class="card-body">
                    <form action="<?= BASE_URL . 'admin/laboratorium/hasil-lab-antigen/save_input_hasil.php' ?>" method="POST"  onsubmit="var r = confirm('Apakah data hasil sudah benar ?'); if (r == true){return true;} else {event.preventDefault; return false;}">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-6">
