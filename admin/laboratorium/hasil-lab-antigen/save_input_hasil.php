...
if ($pemeriksaan == '' || $spesimen == '' || $hasil_pemeriksaan == '') {
    ...
    if ($cek_barcode->num_rows > 0) {
        ...
        if ($query) {
            ...
            $conn->query("INSERT INTO log_file (id, karyawanID, waktu, infoActivity) VALUES (null, '$idKaryawan', NOW(), 'Input hasil Antigen')");
            
            echo '<script>alert("Data hasil dengan NIK/Passport ' . $nik . ' berhasil ditambahkan !");window.location.href="https://reservasi.norbumedika.id/admin/admin.php?page=hasil-lab-antigen";</script>';
