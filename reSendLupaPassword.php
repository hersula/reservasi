...
$select_user = mysqli_query($conn, "select * from master_pasien where email='$email'");
//echo $select_user;
//exit;
if(mysqli_num_rows($select_user) >=1) {
    ...
    try {
        ...
        $mail->Body    = "Untuk mengubah password anda silahkan klik link di bawah ini.
            <a target='blank' href='" . BASE_URL . "Lupa_Password.php?page=lupa-password&email=".$admin_email."'><i>Click Disini !</i></a><br><br><br><a target='blank' href='" . BASE_URL . "'>Subscribe</a>";
    ...
    echo '<script>
              ...
              window.location.href = "'.BASE_URL.'Lupa_Password.php";
              </script>';
